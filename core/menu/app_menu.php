...
$apps[$x]['menu'][0]['title']['zh-cn'] = "菜单管理员";
...
$apps[$x]['menu'][3]['title']['zh-cn'] = "拨号规则";
...
$apps[$x]['menu'][5]['title']['zh-cn'] = "高级设置";
