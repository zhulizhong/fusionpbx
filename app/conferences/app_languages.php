<?php
	...
	$text['description']['fr-fr'] = "Ce menu est utilisé pour créer des salles de conférence avec un nom, une description et en option un code PIN.";
        $text['description']['zh-cn'] = "会议用来创建会议室和会议室名称，会议室描述和可选的会议室密码。";
	...
	$text['label-active_conferences']['zh-cn'] = "进行的会议";
	...
	$text['button-view_active']['en-us'] = "查看进行的会议";
	...
	$text['confirm-delete']['zh-cn'] = "完全删除";
	...
	$text['confirm-profile']['zh-cn'] = "请提供: 属性";
	...
	$text['confirm-enabled']['zh-cn'] = "请提供: 开启设置";
	...
	$text['description-name']['zh-cn'] = "请输入会议名称。";
	...
	$text['description-extension']['zh-cn'] = "请输入会议分机号码。";
	...
	$text['description-3']['zh-cn'] = "监控会议室，和会议室互动。";
	...
	$text['description-pin']['zh-cn'] = "可选会议室密码。";
	...
	$text['confirm-delete-2']['zh-cn'] = "需要删除这个设置吗？";
	...
	$text['label-description']['fr-fr'] = "Description";
	$text['label-description']['zh-cn'] = "请输入描述信息。";
	...
	$text['description-conference-enable']['zh-cn'] = "选择是否开启或关闭此会议。";
	...
	$text['description-order']['zh-cn'] = "输入顺序号码。";
	...
	$text['description-user-add']['zh-cn'] = "指定这个用户来管理会议分机。";
	...
	$text['description-profile']['zh-cn'] = "相关会议属性文件。"；
	...
	$text['description-flags']['zh-cn'] = "可选会议标志符。例如: mute|deaf|waste|moderator";
